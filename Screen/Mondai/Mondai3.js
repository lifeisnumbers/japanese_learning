  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.buttonContainer}>
        ...
        <Text style={styles.label1}>1.おくには　どちらですか</Text> 
        <Text style={styles.label4}>Đất nước bạn là đâu vậy?</Text>
        <Text style={styles.label2}>イギリスです。</Text>
        <Text style={styles.label4}>Là Anh.</Text> 
        <Text style={styles.label1}>2.うちは　どちらですか。。</Text> 
        <Text style={styles.label4}>Nhà bạn ở đâu vậy?</Text>
